...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Bank Transactions (<?php echo currency.' '.$bank_amount;?>) </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-hover" id="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary btn-sm" href="<?php echo base_url('Admin/Management/checkBankTransaction/'.$request['id'].'')?>" target="_blank">View Report</a></td>
                                    </tr>
                                    <?php
                                    $i++;
                                    }
