...
<!-- Stylesheet file -->
<link rel="stylesheet" href="<?php echo base_url('P_assets/css/style.css'); ?>">
	
<!-- Stripe JavaScript library -->
<script src="https://js.stripe.com/v2/"></script>
	
<!-- jQuery is used only for this example; it isn't required to use Stripe -->
<script src="<?php echo base_url('P_assets/js/jquery.min.js'); ?>"></script>
...
<div class="container">
	...
	<div class="panel">
		...
		<div class="panel-body">
			...
			<!-- Payment form -->
			<?php echo form_open('','id="paymentFrm"')?>
