...
<html lang="en">
    ...
    <style>
body{background: url('<?php echo base_url('uploads/register-bg.jpg') ;?>');
                        ...
                        <div class="col-12 col-md-6 columns">
                            <div class="form-wrapper">
                                <div class="page-header text-center">
                                    ...
                                    <p class="small">Join Hunter king to Start your earning.!</p>
                                </div>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <?php echo form_open('Dashboard/Register/Register?sponser_id=' . $sponser_id, array('id' => 'RegisterForm')); ?>
                                    ...
                                    <div class="Accept">
                                        ...
                                        I have read the   <a style="cursor:pointer;color:white; font-size:16px" target="_blank" href="<?php echo base_url('Site/Main/content/terms');?>" target="_blank">Terms &amp; Conditions</a>
                                    ...
                                    <p style="text-align:center"> Have Account? <a style="background:orange;color:white;padding:10px 20px; border-radius:10px" href="<?php echo base_url('Dashboard/User/login'); ?>">Login Now</a></p>
                                </div>
